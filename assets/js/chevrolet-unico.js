...
const chevroletModelo = params.get('modelo');
...
const renderizarDetalleVehiculo = (vehiculo) => {
  const vehiculoDetailContainer = document.getElementById("chevroletDetailContainer");
...
document.addEventListener("DOMContentLoaded", () => {
  obtenerDetallesVehiculo(chevroletModelo);
});